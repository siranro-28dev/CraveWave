    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img id="product-img" class="product-img" src="img/meal4.png" width="100%" id="MainImg" alt="">
            </div>

            <div class="single-pro-details">
                <h6>Home / Meal Boxes</h6>
                <h4 class="product-title">Meal 4</h4>
                <h2 class="price">Rs.100</h2>
                <select>
                    <option>Customize</option>
                    <option>No Rice</option>
                    <option>2 Chapati</option>
                    <option>Raita</option>
                </select>
                <!-- <input type="number" value="1"> -->
                <button id="addtocart-btn">Add To Cart</button>
                <h4>Meal Details</h4>
                <span>This is a nutritious meal of Indian curry, dal and salad that comprises a total of 772 calories.
