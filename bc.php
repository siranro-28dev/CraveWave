    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img id="product-img" class="product-img" src="img/butter.png" width="100%" id="MainImg" alt="">
            </div>

            <div class="single-pro-details">
                <h6>Home / Meals</h6>
                <h4 class="product-title">Butter Chicken</h4>
                ...
                <h4>Meal Details</h4>
                <span>Butter chicken is an Indian dish originating in New Delhi.  It is a type of curry made from chicken with a spiced tomato and butter (makhan) sauce.
