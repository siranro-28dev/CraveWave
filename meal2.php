    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img id="product-img" class="product-img" src="img/meal2.png" width="100%" id="MainImg" alt="">
            </div>

            <div class="single-pro-details">
                <h6>Home / Meal Boxes</h6>
                <h4 class="product-title">Meal 2</h4>
                ...
                <select>
                    ...
                    <option>No Gulab Jamun</option>
                    <option>Raita</option>
                </select>
                <!-- <input type="number" value="1"> -->
                <button id="addtocart-btn">Add To Cart</button>
                <h4>Meal Details</h4>
                <span>This meal comprises a total of 1246 calories.
