    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img id="product-img" class="product-img" src="img/chickpea.png" width="100%" id="MainImg" alt="">
            </div>

            <div class="single-pro-details">
                <h6>Home / Meals</h6>
                <h4 class="product-title">Chickpea Salad</h4>
                ...
                <h4>Meal Details</h4>
                <span>Chickpea Salad loaded with crisp cucumbers, juicy tomatoes, creamy avocado, feta cheese and chickpeas or garbanzo beans. Fresh, healthy and protein packed
