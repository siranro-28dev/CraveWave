    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img id="product-img" class="product-img" src="img/meal1.png" width="100%" id="MainImg" alt="">
            </div>

            <div class="single-pro-details">
                <h6>Home / Meal Boxes</h6>
                <h4 id="product-title" >Meal 1</h4>
                <h2 id="price">Rs.100</h2>
                <select>
                ...
                <h4>Meal Details</h4>
                <span>This meal comprises a total of 731 calories.
        ...
        <!-- <script src="./frontend/addToCart.js"></script> -->
    </body>
