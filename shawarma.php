    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            ...
            <div class="single-pro-image">
                <img id="product-img"  class="product-img" src="img/shawarma.png" width="100%" id="MainImg" alt="">
            </div>
            <div class="single-pro-details">
                <h6>Home / Meals</h6>
                <h4 class="product-title">Shawarma</h4>
                ...
                <h4>Meal Details</h4>
                <span>Shawarma is a popular Middle Eastern dish consisting of meat cut into thin slices, stacked in an inverted cone, and roasted on a slowly turning vertical rotisserie or spit.
