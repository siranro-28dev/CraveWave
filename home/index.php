...
<html lang="en">
    ...
    <body>
        ...
        <section id="main">
            <h1>Crave Wave</h1>
            <h8>YOU ARE WHAT YOU EAT</h8>
            <button><a href="http://localhost/miniproj/menu">Lets Eat</a></button>
        </section>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro">
                    <img src="../img/biryani.png" alt="" class="product-img">
                    <div class="des">
                        <h5 class="product-title">BIRYANI</h5>
                        <div class="star">
                ...
                <div class="pro">
                    <img src="../img/cnr.png" alt="">
                    <div class="des">
                        <h5>CHICKEN AND RICE</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
