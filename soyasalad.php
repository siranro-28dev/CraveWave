    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img id="product-img" class-="product-img" src="img/soyasalad.png" width="100%" id="MainImg" alt="">
            </div>

            <div class="single-pro-details">
                <h6>Home / Meals</h6>
                <h4 class="product-title">Soya Chunks Salad</h4>
                ...
                <h4>Meal Details</h4>
                <span>Soya Chunks Salad is a quick meal recipe made with olives, sweet corn, mushrooms, soya nuggets, hung curd and lettuce leaves. This nutritious and light recipe is perfect for health-conscious people.
